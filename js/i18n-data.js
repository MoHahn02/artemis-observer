...
export const TEXT = {
    en: {
        ...
        'eclipse.kicker': 'Next solar eclipse',
        'eclipse.type.total': 'Total solar eclipse',
        'eclipse.type.annular': 'Annular solar eclipse',
        'eclipse.today': 'Today',
        'eclipse.inOneDay': 'In 1 day',
        'eclipse.inDays': 'In {count} days',
        'eclipse.partialNote': 'The blue area is a schematic overview; the orange corridor follows the NASA path limits.',
        'eclipse.source': 'Open NASA path data',
        ...
        'sky.subtitle': 'Point your phone at the sky. Tap satellites for details.',
        ...
        'sky.calibration.start': 'Calibrate',
        'sky.calibration.done': 'Done',
        'sky.calibration.status': 'Hold the phone steady, drag the overlay into place, then tap Done',
        'sky.offscreen.hide': 'Hide off-screen',
        'sky.offscreen.show': 'Show off-screen',
        'sky.satellite.title': 'Satellite',
        'sky.satellite.close': 'Close satellite details',
        'sky.satellite.altitude': 'Altitude',
        'sky.satellite.elevation': 'Elevation',
        'sky.satellite.direction': 'Direction',
        'sky.satellite.distance': 'Distance',
        'sky.satellite.noDetails': 'No additional catalog details',
    ...
    de: {
        ...
        'eclipse.kicker': 'Nächste Sonnenfinsternis',
        'eclipse.type.total': 'Totale Sonnenfinsternis',
        'eclipse.type.annular': 'Ringförmige Sonnenfinsternis',
        'eclipse.today': 'Heute',
        'eclipse.inOneDay': 'In 1 Tag',
        'eclipse.inDays': 'In {count} Tagen',
        'eclipse.partialNote': 'Der blaue Bereich ist eine schematische Übersicht; der orange Korridor folgt den NASA-Pfadgrenzen.',
        'eclipse.source': 'NASA-Pfaddaten öffnen',
        ...
        'sky.subtitle': 'Richte dein Handy in den Himmel. Tippe Satelliten fuer Details an.',
        ...
        'sky.calibration.start': 'Kalibrieren',
        'sky.calibration.done': 'Fertig',
        'sky.calibration.status': 'Handy ruhig halten, Overlay passend ziehen und dann Fertig tippen',
        'sky.offscreen.hide': 'Ausserhalb ausblenden',
        'sky.offscreen.show': 'Ausserhalb anzeigen',
        'sky.satellite.title': 'Satellit',
        'sky.satellite.close': 'Satelliten-Info schliessen',
        'sky.satellite.altitude': 'Hoehe',
        'sky.satellite.elevation': 'Elevation',
        'sky.satellite.direction': 'Richtung',
        'sky.satellite.distance': 'Entfernung',
        'sky.satellite.noDetails': 'Keine weiteren Katalogdetails',
...
export const STATIC_TRANSLATIONS = {
    en: {
        ...
        'Richte dein Handy in den Himmel. Tippe Satelliten fuer Details an.': 'Point your phone at the sky. Tap satellites for details.',
        'Kalibrieren': 'Calibrate',
        'Ausserhalb ausblenden': 'Hide off-screen',
        'Satelliten-Info schliessen': 'Close satellite details',
        'Hoehe': 'Altitude',
        'Richtung': 'Direction',
        'Entfernung': 'Distance',
        ...
        'Mond': 'Moon',
        'Sonnenfinsternis schließen': 'Close solar eclipse',
        'Maximale Totalität': 'Maximum totality',
        'Datenzeit': 'Data frame',
        'Legende der Sonnenfinsternis-Projektion': 'Solar eclipse projection legend',
        'Totalitätspfad': 'Path of totality',
        'Partielle Sichtbarkeit': 'Partial visibility',
